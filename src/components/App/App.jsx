...
function App() {
  ...
  const [isModalOpen, setIsModalOpen] = useState({isOpen: false, type: null, selectedItem: null});
      ...
      <div className="app">
        ...
        <ModalWithForm 
         ...
         <fieldset className="form__set">
            <label htmlFor="" className="form__field">Name
              <input 
                type="text" 
            ...
            <label htmlFor="" className="form__field">Image 
                <input 
                type="url" 
                className="form__input" 
        ...
        <fieldset className="form__set form__radio-set">
            <legend className="form__title form__legend__title">Select the weather type:
                <label htmlFor="" className="form__radio-field ">Hot
                    <input
                      type="radio" 
                      id="hot" 
                      name="weather" 
                ...
                <label htmlFor="" className="form__radio-field">Warm
                    <input 
                    type="radio" 
                    id="warm" 
                    name="weather" 
                ...
                <label htmlFor="" className="form__radio-field">Cold
                    <input 
                    type="radio" 
                    id="cold" 
                    name="weather" 
